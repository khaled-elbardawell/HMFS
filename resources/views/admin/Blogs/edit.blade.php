...
@section('content')
    ...
    {!! Builder::Form('PUT',route('blogs.update',[$blog->id]),"multipart/form-data") !!}
          <div class="row">
        <div class="col-lg-9">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        {!!   Builder::Input('text','title',$blog->title,['label_title' => 'admin.Title','use_trans' => true,'is_required' => true]) !!}
                        {!!   Builder::TextArea('excerpt',$blog->excerpt,['label_title' => 'admin.Excerpt','use_trans' => true]) !!}
                        {!!   Builder::TextArea('description',$blog->description,['label_title' => 'admin.Description','use_trans' => true]) !!}
                    </div>
                </div><!--end card-body-->
            </div><!--end card-->
        </div><!--end col-->
