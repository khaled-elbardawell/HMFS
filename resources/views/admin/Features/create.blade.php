...
@section('content')
    ...
    <!-- end page title end breadcrumb -->
       ...
       <?php  use App\Helpers\Builder; ?>
        ...
        {!! Builder::Form('POST',route('features.store'),"multipart/form-data") !!}
           <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                           {!!   Builder::Input('text','key',null,['label_title' => 'admin.Key','use_trans' => true,'is_required' => true , 'col' => 'col-md-6']) !!}
                        {!!   Builder::Input('text','value',null,['label_title' => 'admin.Value','use_trans' => true,'is_required' => true , 'col' => 'col-md-6']) !!}
                        </div>
                    </div><!--end card-body-->
                </div><!--end card-->
            </div><!--end col-->
