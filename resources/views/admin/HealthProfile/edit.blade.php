...
@section('content')
    ...
    {!! Builder::Form('PUT',route('health-profile.update',[$healthProfile->id,'user_id' => request()->user_id]),"multipart/form-data") !!}
          <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        {!!   Builder::Input('text','title',$healthProfile->title,['col' => 'col-lg-6','label_title' => 'admin.Title','use_trans' => true,'is_required' => true]) !!}
                        {!!  Builder::Select('doctor_id',$healthProfile->doctor_id,$doctors,['col' => 'col-lg-6','option_title' =>  'name','option_key_value' => 'id','label_title' => 'reservations::admin.Doctor_name','use_trans' => true,'is_required' => true])  !!}

                        {!!   Builder::TextArea('description',$healthProfile->description,['label_title' => 'admin.Description','use_trans' => true,'is_required' => true]) !!}
                        {!!   Builder::TextArea('recommendations',$healthProfile->recommendations,['label_title' => 'admin.Recommendations','use_trans' => true]) !!}
                        {!!   Builder::TextArea('requests',$healthProfile->requests,['label_title' => 'admin.Requests','use_trans' => true]) !!}
