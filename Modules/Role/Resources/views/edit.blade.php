            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__('role::admin.Edit')}}</li>
                    </ol>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input name="name" class="form-control" type="text" placeholder="{{__('role::admin.Name')}}" value="{{$role->name}}" id="example-text-input">
                                        @error('name')
                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="form-check-inline my-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input name="permissions[]" value="{{$permission->id}}" type="checkbox" class="custom-control-input" id="permission_{{$permission->id}}" @foreach($role->permissions as $p) @if($p->id == $permission->id) checked="true" @endif  @endforeach data-parsley-multiple="groups" data-parsley-mincheck="2">
